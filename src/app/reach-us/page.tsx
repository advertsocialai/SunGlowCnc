    ...
    <div className="d-flex flex-column min-vh-100" style={{ background: 'var(--dark-bg)' }}>
      ...
      <section className="page-header">
        <div className="container-xl">
          <p className="text-brand-red fw-semibold text-uppercase letter-wide mb-2" style={{ fontSize: '0.9rem' }}>Get Directions</p>
          ...
          <div className="row g-5">
              ...
              <div className="d-flex flex-column gap-4">
                ...
                <div className="bg-brand-navy rounded-xl p-4">
                  <div className="d-flex align-items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-brand-red mb-0" style={{ fontSize: '0.9rem' }}>CNC Milling Works · Since 2003</p>
                    </div>
                  </div>
                  {/* Google rating */}
                  <div className="d-flex align-items-center gap-2 p-3 rounded mb-3" style={{ background: 'rgba(255,255,255,0.07)' }}>
                    ...
                    <span className="text-white fw-bold" style={{ fontSize: '0.95rem' }}>4.2</span>
                    <span className="text-muted" style={{ fontSize: '0.85rem' }}>(5 reviews on Google)</span>
                  </div>
                  <div className="d-inline-flex align-items-center gap-2 px-3 py-2 rounded fw-semibold" style={{ background: 'rgba(34,197,94,0.15)', border: '1px solid rgba(34,197,94,0.35)', color: '#4ade80', fontSize: '0.92rem' }}>
                ...
                <div className="dark-card p-4">
                  <div className="d-flex gap-3">
                    ...
                    <div>
                      <p className="text-muted text-uppercase letter-wide fw-semibold mb-1" style={{ fontSize: '0.82rem' }}>Address</p>
                ...
                <div className="dark-card p-4">
                  <div className="d-flex gap-3">
                    ...
                    <div className="flex-grow-1">
                      <p className="text-muted text-uppercase letter-wide fw-semibold mb-1" style={{ fontSize: '0.82rem' }}>Phone</p>
                      <p className="text-white fw-bold mb-3" style={{ fontSize: '1.05rem' }}>+91 92463 51511</p>
                      <div className="d-flex gap-2 flex-wrap">
                        <a href="tel:+919246351511" className="btn-brand" style={{ padding: '0.45rem 1.1rem', fontSize: '0.92rem' }}>
                          📞 Call Now
                        </a>
                ...
                <div className="dark-card p-4">
                  <div className="d-flex gap-3">
                    <div className="d-flex align-items-center justify-content-center rounded flex-shrink-0" style={{ width: 44, height: 44, background: 'var(--brand-red-light)', fontSize: '1.2rem' }}>✉</div>
                    <div>
                      <p className="text-muted text-uppercase letter-wide fw-semibold mb-1" style={{ fontSize: '0.82rem' }}>Email</p>
            ...
            <div className="col-lg-7">
              ...
              <div className="dark-card p-4 mt-4">
                ...
                <Link href="/dashboard/rfq/new" className="btn-brand" style={{ fontSize: '0.95rem' }}>
                  Submit RFQ Online →
                </Link>
              </div>
            </div>
