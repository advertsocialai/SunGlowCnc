            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex gap-3 w-full md:w-auto">
                <input
                  ...
                  className="flex-1 md:w-72 bg-slate-700 border border-slate-600 text-white placeholder-slate-400 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
                <button
                  type="submit"
                  className="bg-orange-600 hover:bg-orange-700 text-white font-semibold px-5 py-2.5 rounded-lg transition-colors text-sm whitespace-nowrap"
                >
                  Subscribe
                </button>
              </form>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-orange-600/20 border border-orange-600/30 text-orange-400 text-xs px-2.5 py-1 rounded">ISO 9001</span>
              <span className="bg-orange-600/20 border border-orange-600/30 text-orange-400 text-xs px-2.5 py-1 rounded">GMP</span>
              <span className="bg-orange-600/20 border border-orange-600/30 text-orange-400 text-xs px-2.5 py-1 rounded">AS9100</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-2">
              <div className="flex gap-2 text-xs text-slate-400">
                <svg className="w-3.5 h-3.5 text-orange-500 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
